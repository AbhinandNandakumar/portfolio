    ...
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <label
            className="md:hidden flex flex-col gap-2 w-8 cursor-pointer"
            onClick={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <div className="rounded-xl h-[2px] w-1/2 bg-cyan-100 duration-500 eer-checked:rotate-[225deg] origin-right " />
            <div className="rounded-xl h-[3px] w-full bg-cyan-100" />
            <div className="rounded-xl h-[2px] w-1/2 bg-cyan-100 duration-500 place-self-end origin-left " />
          </label>
        </div>
